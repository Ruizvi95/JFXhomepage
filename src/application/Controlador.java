...
public class Controlador {
	@FXML
	private AnchorPane pane1, pane2, pane3, pane4, opacity, drawer;
...
//        pane2.setStyle("-fx-background-image: url('application/foto2.jpg')");
//        pane3.setStyle("-fx-background-image: url('application/foto3.jpg')");
//        pane4.setStyle("-fx-background-image: url('application/foto4.jpg')");
        ...
        drawerImage.setOnMouseClicked(event -> {
            ...
            FadeTransition fadeTransition1=new FadeTransition(Duration.seconds(0.5),opacity);
            fadeTransition1.setFromValue(0);
            fadeTransition1.setToValue(0.6);
            fadeTransition1.play();

            TranslateTransition translateTransition1=new TranslateTransition(Duration.seconds(0.5),drawer);
            translateTransition1.setByX(+300);
            translateTransition1.play();
        });

        opacity.setOnMouseClicked(event -> {
